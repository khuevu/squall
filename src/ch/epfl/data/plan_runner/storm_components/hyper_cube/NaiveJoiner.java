...
public class NaiveJoiner extends StormBoltComponent {
    private static final long serialVersionUID = 1L;
    private static Logger LOG = Logger.getLogger(NaiveJoiner.class);
    ...
    public NaiveJoiner(final StormEmitter firstEmitter,
                          final StormEmitter secondEmitter, ComponentProperties cp,
        ...
        final int parallelism = 1; //SystemParameters.getInt(conf, getID() + "_PAR");
        _operatorChain = cp.getChainOperator();
        _joinPredicate = joinPredicate;
        InputDeclarer currentBolt = builder.setBolt(getID(), this, parallelism);

        ArrayList<StormEmitter> emitters = new ArrayList<StormEmitter>(){{add(firstEmitter); add(secondEmitter);}};
