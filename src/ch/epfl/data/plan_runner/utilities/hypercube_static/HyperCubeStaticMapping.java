 ...
 */
public class HyperCubeStaticMapping implements CustomStreamGrouping {
    private static final long serialVersionUID = 1L;
    private static Logger LOG = Logger.getLogger(HyperCubeStaticMapping.class);
    ...
    public HyperCubeStaticMapping(String[] emitterIndexes,
