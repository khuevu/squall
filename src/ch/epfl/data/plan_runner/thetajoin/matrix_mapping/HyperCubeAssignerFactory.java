...
import ch.epfl.data.plan_runner.thetajoin.matrix_mapping.HyperCubeAssignment.Dimension;
...
public class HyperCubeAssignerFactory<KeyType> {
	...
	public static void main (String... args){
		...
		System.out.println("Get Regions of dimension 1: " + assigner.getRegionIDs(Dimension.d(0)).toString());
	}
